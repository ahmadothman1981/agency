              ...
              <div class="card shadow">
                    ...
                    <div class="col-md-6">
                      ...
                      <x-form-label title="title"></x-form-label>
                        <input type="text" id="simpleinput" name="title" class="form-control" placeholder="{{__('keywords.title')}}" value="{{$feature->title}}">
                    ...
                    <div class="col-md-6">
                      ...
                      <x-form-label title="icon"></x-form-label>
                        <input type="text" id="simpleinput" name="icon" class="form-control" placeholder="{{__('keywords.icon')}}" value="{{$feature->icon}}">
                    ...
                    <div class="col-md-12">
                      ...
                      <x-form-label title="description"></x-form-label>
                        <textarea  id="simpleinput" name="description" class="form-control" placeholder="{{__('keywords.description')}}">{{$feature->description}}</textarea>
