              ...
              <div class="card shadow">
                    ...
                    <div class="col-md-6">
                      <div class="form-group mb-3">
                        ...
                        <input disabled type="text" id="simpleinput" name="title" class="form-control" value="{{$service->title}}" placeholder="{{__('keywords.title')}}">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group mb-3">
                    ...
                    <div class="col-md-12">
                      <div class="form-group mb-3">
                        ...
                        <textarea disabled id="simpleinput"  name="description" class="form-control" placeholder="{{__('keywords.description')}}">{{$service->description}}</textarea>
                      </div>
                    </div>
                  </div>                
