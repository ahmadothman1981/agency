                      ...
                      <table class="table table-hover">
                        <thead>
                          <tr>
                            ...
                            <th width="20%">{{__('keywords.description')}}</th>
                        ...
                        @if(count($testmonials) > 0 )
                            ...
                            <td><img src="{{asset("storage/testmonials/$testmonial->image")}}" width="100" alt="testmonial"></td>
                            <td>
                            <i class="{{$testmonial->icon}} fa-2x"></i></td>
                            <td>
